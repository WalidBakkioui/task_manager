 ...
 */
final class Version20250427151348 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE task CHANGE completed completed TINYINT(1) DEFAULT 0 NOT NULL
        SQL);
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE task CHANGE completed completed TINYINT(1) NOT NULL
        SQL);
    }
}
